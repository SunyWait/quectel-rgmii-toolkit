...
echo "                                           :+##+.            "
    ...
    echo -e "\e[92m"
    echo "Welcome to SunyWait's RGMII Toolkit script for Quectel RMxxx Series modems!"
    echo "Visit https://raw.gitmirror.com/SunyWait for more!"
    echo -e "\e[0m"
    ...
    case $choice in
		...
		12) 
			...
			mkdir /usrdata/root
     	    mkdir /usrdata/root/bin
			cd /usrdata/root/bin
     	    wget -O fast https://raw.gitmirror.com/ddo/fast/releases/download/v0.0.4/fast_linux_arm && chmod +x fast
     	    cd /
